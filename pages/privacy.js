...
export default function Privacy() {
  return (
    <div>
      <h3 className="text-4xl font-black mt-8">Privacy Policy</h3>
      <p className="mb-8">Last updated: 23 September 2022</p>
      <p className="my-4">
      ...
      <h3 class="subHeadPvc text-xl font-black my-4">Interpretation</h3>
      <p className="my-4">
      ...
      <h2 className="text-2xl font-black">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p className="my-4">
            ...
            this Agreement) refers to The Programming Buddy Club , 18 Kestrel
            Drive .
          </p>
        </li>
        <li>
        ...
        <li>
          <p className="my-4">
            <strong>Website</strong> refers to The Programming Buddy Club ,
            accessible from{" "}
            <a
              href="theprogrammingbuddy.club"
      ...
      <h2 class="subHeadPvcH2 text-2xl font-black my-8">
        Collecting and Using Your Personal Data
      </h2>
      <h3 class="subHeadPvc  text-xl font-black my-4">
        Types of Data Collected
      </h3>
      <h3 class="subHeadPvc text-xl font-black my-4">Personal Data</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">Usage Data</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">
      ...
      <h3 className="text-xl font-black my-4">Use of Your Personal Data</h3>
      <p className="my-4">
      ...
      <h3 class="subHeadPvc text-xl font-black my-4">Business Transactions</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">Law enforcement</h3>
      <p className="my-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="text-xl font-black my-4">Other legal requirements</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">Children&#x27;s Privacy</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">Links to Other Websites</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-black my-4">Contact Us</h3>
      <p className="my-4">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>By email: programmingbuddyclub@gmail.com</li>
      </ul>
    </div>
  )
}
